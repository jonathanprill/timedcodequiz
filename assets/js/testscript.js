...
//  highScores.push("STRING");
//  localStorage.setItem(highScores, JSON.stringify('scoreKey'));
//  // highScores = JSON.parse(localStorage.getItem('scoreKey')) || [];
...
// //         //     ('scoreKey').append(localStorage.getItem(localStorage.key(i)));
// //         // }
// //        // var highScores = JSON.parse(localStorage.getItem("scoreKey") || '[]');
